      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Building sustainable communities through smart waste management solutions across India.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 EcoWaste India Management System. All rights reserved.</p>
            <p className="mt-2 text-sm">
              Supporting India's Swachh Bharat Mission | Smart Cities Initiative
            </p>
          </div>
        </div>
      </footer>
