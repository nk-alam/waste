...
const SIHSolutionPage: React.FC = () => {
  ...
  const solutions = [
    {
      id: 1,
      title: "AI-Powered Citizen Training",
      description: "Machine learning-driven waste management education with adaptive learning paths",
      features: ["AI-personalized training modules", "Smart 3-bin distribution system", "IoT-enabled compost kits", "Neural network monitoring"],
    ...
    {
      id: 2,
      title: "Intelligent Worker Training",
      description: "Computer vision-enhanced safety protocols with predictive skill assessment",
      features: ["AR/VR safety training", "Smart PPE distribution", "AI performance analytics", "Automated certification"],
      icon: FaShieldAlt,
    ...
    {
      id: 3,
      title: "Neural Green Champions Network",
      description: "AI-coordinated decentralized monitoring with predictive anomaly detection",
      features: ["ML-powered area monitoring", "Real-time intelligence alerts", "Automated leadership scoring", "Blockchain-based incentives"],
      icon: FaAward,
    ...
    {
      id: 4,
      title: "Smart Incentive Engine",
      description: "AI-driven rewards system with behavioral prediction and gamification",
      features: ["Machine learning point calculation", "Dynamic reward optimization", "Social impact leaderboards", "NFT achievement badges"],
      icon: FaGift,
      api: "/api/incentives",
      color: "yellow"
    },
    {
      ...
      description: "Advanced image recognition for automated waste violation detection",
      features: ["AI-powered photo analysis", "Geospatial intelligence alerts", "Deep learning classification", "Automated response triggers"],
      icon: FaCamera,
    ...
    {
      id: 6,
      title: "AI Community Orchestration",
      description: "Intelligent scheduling and coordination of community engagement programs",
      features: ["Smart scheduling algorithms", "Predictive participation modeling", "Automated volunteer matching", "Impact measurement analytics"],
      icon: FaHandshake,
      api: "/api/community",
      color: "teal"
    },
    {
      id: 7,
      title: "Predictive Penalty System",
      description: "Machine learning-based compliance prediction with smart enforcement",
      features: ["Behavioral pattern analysis", "Automated violation detection", "Dynamic penalty calculation", "Predictive intervention alerts"],
    ...
    {
      id: 8,
      title: "IoT Smart Facilities Network",
      description: "Connected infrastructure with AI-optimized waste processing",
      features: ["IoT sensor networks", "AI-controlled processing", "Predictive maintenance", "Energy optimization algorithms"],
      icon: MdFactory,
      api: "/api/facilities",
      color: "indigo"
    },
    {
      id: 9,
      title: "Intelligent Digital Ecosystem",
      description: "AI-powered marketplace with recommendation engines and predictive analytics",
      features: ["ML-driven product recommendations", "Smart utility marketplace", "Predictive demand forecasting", "Intelligent logistics optimization"],
      icon: FaShoppingCart,
      api: "/api/shop",
      color: "pink"
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p 
              ...
              variants={fadeIn}
            >
              An AI-powered comprehensive digital solution addressing India's 37,373 tonnes daily waste gap 
              through intelligent training, neural monitoring, and machine learning-driven community engagement.
            </motion.p>
