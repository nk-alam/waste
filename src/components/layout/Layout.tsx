...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Bin Tracking', href: `${basePath}/bin-tracking`, icon: MapPin, current: location.pathname === `${basePath}/bin-tracking` },
    { name: 'Vehicle Tracking', href: `${basePath}/vehicle-tracking`, icon: Navigation, current: location.pathname === `${basePath}/vehicle-tracking` },
    { name: 'Analytics', href: `${basePath}/analytics-dashboard`, icon: BarChart3, current: location.pathname === `${basePath}/analytics-dashboard` },
    { name: 'Reports', href: `${basePath}/reports`, icon: FileText, current: location.pathname === `${basePath}/reports` },
    { name: 'IoT Monitoring', href: `${basePath}/iot-monitoring`, icon: Activity, current: location.pathname === `${basePath}/iot-monitoring` },
